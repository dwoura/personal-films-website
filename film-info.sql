...
create table oss_movieinfo
(
    movie_id         int auto_increment comment '电影主键'
        primary key,
    movie_name       varchar(200)  null comment '电影名称',
    movie_remark     varchar(200)  null comment '电影备注',
    movie_actor      varchar(500)  null comment '电影主演',
    movie_director   varchar(300)  null comment '电影导演',
    movie_cover      varchar(1000) null comment '电影海报',
    movie_type1      int           null comment '电影一级分类',
    movie_type2      int           null comment '电影二级分类',
    movie_area       varchar(200)  null comment '电影发行地区',
    movie_score      varchar(100)  null comment '电影评分',
    movie_lan        varchar(200)  null comment '电影语言',
    movie_showtime   varchar(200)  null comment '电影上映时间',
    movie_updatetime varchar(200)  null comment '电影更新时间',
    movie_content    text          null comment '电影简介',
    movie_playlist1  longtext      null comment '电影播放列表1',
    movie_playlist2  longtext      null comment '电影播放列表2',
    movie_bak1       varchar(500)  null comment '备用字段1',
    movie_bak2       varchar(500)  null,
    movie_bak3       varchar(500)  null,
    create_time      datetime      null comment '创建时间',
...
create table oss_slide
(
    slide_id    int auto_increment comment '幻灯片主键'
        primary key,
    slide_url   varchar(500) null comment '幻灯片地址
',
    create_by   varchar(64)  null comment '创建人',
    create_time datetime     null comment '创建时间
',
...
create table oss_type
(
    type_id     int auto_increment comment '类型主键'
        primary key,
    pid         int           null comment '父类型',
    type_level  int           null comment '类型级别',
    type_desc   varchar(1000) null comment '类型描述',
    create_by   varchar(64)   null comment '创建人',
    create_time datetime      null comment '创建时间',
    update_by   varchar(64)   null comment '更新人',
    update_time datetime      null comment '更新时间',
    type_name   varchar(200)  null comment '类型名称'
)
    comment '分类管理
';
